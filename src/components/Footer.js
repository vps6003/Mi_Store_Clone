       ...
       <>
        ...
        <div className="footer">
                 ...
                 <p> CONTACT US</p>
                  ...
                  <div>
                      <div>Chat with our Virtual AI Bot(24/7 Live Agent Support)</div><a href='https://in.chat.kefu.mi.com/page/index/v2?tag=in&token=aW4jNTAwMCNpbi53ZWIubWkjd2Vic2l0ZSNnb29kc0RldGFpbA==&groupId=P0&locale=en&closedshow=1' target="__blank"><button>CHAT NOW</button></a>
                  </div>
